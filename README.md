Esta aplicacion consiste en un simulador de gastos. En el mismo se pedira mediante opciones que el usuario seleccione si quiere ingresar un gasto, ingreso o cancelar. 
